...
const Details = () => {
  return (
    <section className='max-w-100max w-full my-0 mx-auto py-0 px-8 mb-64 flex justify-between items-center relative md:justify-center md:mb-16 '>
      <div className='max-w-15rem mm:hidden'>
      ...
      <Image src="/coffee2.png" alt="café" width={340} height={225} className='absolute top-8 left-1/2 -translate-x-1/2 md:hidden'/>
